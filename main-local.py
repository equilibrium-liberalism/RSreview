...
OPENAI_API_KEY = "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"
app = Flask(__name__)
CORS(app)
...
class Chatbot():
    ...
    def create_prompt(self, df, user_input):
        ...
        if the orignal language is not english ,you must understand the orignal language and given the answers in english.
